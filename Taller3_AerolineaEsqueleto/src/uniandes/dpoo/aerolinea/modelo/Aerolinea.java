...
public class Aerolinea
{
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
    	...
    	int tiquetes= vuelo.getTiquetes().size();
    	
    	if (capacidad-tiquetes<cantidad) {
        ...
        total = vuelo.venderTiquetes(cliente, calculadoraTarifas, cantidad);
    ...
    /**
     * Registra que un cierto vuelo en una ruta fue realizado.
     * @param fecha La fecha del vuelo (en formato "DD-MM-YYYY").
     * @param codigoRuta El código de la ruta que recorrió el vuelo.
     * @throws Exception Si la ruta no coincide o el vuelo no ha sido encontrado.
     */
    public void registrarVueloRealizado(String fecha, String codigoRuta) throws Exception {
        ...
        if (!rutaVuelo.getCodigoRuta().equals(codigoRuta)) {
            throw new Exception();
        }
 ...
 * @return La suma de lo que pagó el cliente por los tiquetes sin usar como String
 */
public String consultarSaldoPendienteCliente(String identificadorCliente) {
    ...
    return Double.toString(saldoPendiente);
}}
